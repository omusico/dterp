...
public class updownHibernate extends TagSupport {
  ...
  String escape_sql=NseerFileTree.escape(sql);
   ...
   if (intPage < PageCount) {
         ...
         pageContext.getOut().print(demo.getLang("erp","共")+PageCount+demo.getLang("erp","页")+"  &nbsp;&nbsp;&nbsp;"+demo.getLang("erp","跳到第")+" <input id=nseer_page type=text class=input1 size=1> "+demo.getLang("erp","页")+"&nbsp;&nbsp;"+"<img  src=\""+request.getContextPath()+"/images/go.bmp\" width=18 height=18 border=0 onclick=\"nseer_href()\">");	 
