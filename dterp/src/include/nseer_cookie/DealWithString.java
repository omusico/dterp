...
public class DealWithString{
	...
	public String joinIn(String a,String b) {
		...
		int filenum=count.read("ondemand2","erpAttachmentcount");

		count.write("ondemand2","erpAttachmentcount",filenum);
		s = a+filenum+b;
		return s;
    }
	//逆
    public String[] divide(String c,int k){
		counter count=new counter(dbApplication);
		String filenum=count.read("ondemand2","erpAttachmentcount")+"";
		ss[0]="";
		ss[1]="";
		if(!c.equals("")){
