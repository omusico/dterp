...
String type="零售非会员";
	...
	String sql3 = "insert into crm_order(order_ID,chain_ID,chain_name,hr_file_ID,hr_file_name,customer_ID,customer_name,register_time,accomplish_time,sales_name,sales_ID,register,type,remark,check_tag,excel_tag,order_type,bonus_calculate_type) values ('"+order_ID1+"','"+rs1.getString("chain_ID")+"','"+rs1.getString("chain_name")+"','"+rs1.getString("hr_chain_ID")+"','"+rs1.getString("hr_chain_name")+"','"+rs1.getString("customer_ID")+"','"+rs1.getString("customer_name")+"','"+rs1.getString("register_time")+"','"+rs1.getString("register_time")+"','"+rs1.getString("sales_name")+"','"+rs1.getString("sales_ID")+"','"+rs1.getString("register")+"','"+type+"','"+rs1.getString("remark")+"','0','2','零售','"+sale_bonus_type+"')" ;
