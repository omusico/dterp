...
String sql1="insert into intrmanufacture_intrmanufacture(intrmanufacture_ID,product_ID,product_name,register,register_time,demand_amount,demand_price,demand_cost_price_sum,check_tag,pay_ID_group,apply_ID_group) values('"+intrmanufacture_ID+"','"+product_ID+"','"+product_name+"','"+register+"','"+register_time+"','"+demand_amount_sum+"','"+price+"','"+demand_cost_price_sum+"','5','"+pay_ID_group+"','"+choice_group+"')";
intrmanufacture_db.executeUpdate(sql1);

	String sqll = "update intrmanufacture_intrmanufacture set check_tag='5',intrmanufacture_tag='1',invoice_tag='1',gather_tag='1',stock_gather_tag='1',pay_tag='1' where intrmanufacture_ID='"+intrmanufacture_ID+"'" ;
...
response.sendRedirect("intrmanufacture/intrmanufacture/register_draft_ok.jsp?finished_tag=0");
}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_draft_ok.jsp?finished_tag=1");
}}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_draft_ok.jsp?finished_tag=2");
}
  }else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_draft_ok.jsp?finished_tag=3");
}
}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_draft_ok.jsp?finished_tag=4");
}
