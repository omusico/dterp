...
String content="使用单位简称："+unit_id+"<br>"+"姓名："+human_name+"<br>"+"员工档案编号："+human_ID+"<br>"+"所在部门："+chain_name+"<br>"+"职位分类："+human_major_first_kind_name+"<br>"+"职位名称："+human_major_second_kind_name+"<br>"+"许可证号码："+license_code+"<br>"+"有效期限："+expiry_period+"天"+"<br>"+"发放时间："+register_time;
