...
if(n==0){
	response.sendRedirect("security/config/file/majorSecondKind.jsp");
}else{
if(m<n&&m!=0){
  ...
  session.setAttribute("second_kind_ID",second_kind_ID);
	...
	response.sendRedirect("security/config/file/majorSecondKind_delete_ok_c.jsp");
}else if(m==n){

	response.sendRedirect("security/config/file/majorSecondKind_delete_ok_a.jsp");

}else if(m==0){


response.sendRedirect("security/config/file/majorSecondKind_delete_ok_b.jsp");
