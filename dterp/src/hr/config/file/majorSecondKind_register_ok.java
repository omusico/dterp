	...
	public synchronized void service(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			if (hr_db.conn((String) dbSession.getAttribute("unit_db_name"))) {
				...
				String sqll = "select * from hr_config_major_second_kind where first_kind_ID='"
						+ first_kind_ID
						+ "' and first_kind_name='"
						+ first_kind_name
				...
				if (rs.next()) {
					...
					response
							.sendRedirect("security/config/file/majorSecondKind_register_ok_a.jsp");

				} else {
					String second_kind_ID = "";
					String sql2 = "select * from hr_config_major_second_kind where first_kind_ID='"
							+ first_kind_ID
							+ "' and first_kind_name='"
							+ first_kind_name
							+ "' order by second_kind_ID desc";
					...
					if (rs2.next()) {
						...
						int code2 = code1 + 1;
						code1 = code1 + 2;
						String sql3 = "update hr_config_major_second_kind set second_kind_ID='"
								+ code1
								+ "' where first_kind_ID='"
								+ first_kind_ID
								+ "' and first_kind_name='"
					...
					String sql = "insert into hr_config_major_second_kind(first_kind_ID,first_kind_name,second_kind_ID,second_kind_name) values('"
							+ first_kind_ID
							+ "','"
							+ first_kind_name
							+ "','"
					...
					response
							.sendRedirect("security/config/file/majorSecondKind_register_ok_b.jsp");
