...
<form ENCTYPE="multipart/form-data" method="post" name="mutiValidation" action="../../manufacture_abnormity_UploadFile" onsubmit="return validateForm()">
