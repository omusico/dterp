...
{
%>
,'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("change.jsp?event_product_id=<%=exchange.unHtmls(Integer.toString(rs1.getInt("event_product_id")))%>")><%=demo.getLang("erp","变更")%></div>'<%}else{%>,''<%}%>],	
