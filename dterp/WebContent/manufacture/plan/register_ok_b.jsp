...
<div id="nseerGround" class="nseerGround">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  ...
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick="page_return()"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  <%=demo.getLang("erp","计划数量超出原料数量，请返回重新制定！")%></td>
 </tr>
 </table>
</div>