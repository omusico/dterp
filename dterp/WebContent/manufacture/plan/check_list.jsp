...
<%
		...
		String my_sql_search = "select id,plan_id,plan_type,plan_maker,plan_make_time,plan_register,plan_register_time,plan_check_tag FROM product_plan where plan_check_tag =0 "+ my_condition + " order by id desc ";
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		登记时间：
		<input type="text" onkeydown="return false" name="register_timeS" id="date_start" value="<%=register_timeS %>" style="width: 150">&nbsp;
		生产计划类型：
...
nseer_grid.column_width=[100,120,100,100,100,120,60];
