...
<tr <%=TR_STYLE1%> class="TR_STYLE1" style="display:none">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="14%" style="vertical-align:middle; text-align:left;display:none"><%=demo.getLang("erp","1：模具台编号记录与实物编号相符")%></td>
...
<td <%=TD_STYLE4%> class="TD_STYLE1" width="14%" style="vertical-align:middle; text-align:left;" style="display:none"><%=demo.getLang("erp","5：纸带顶紧滑块、纸粉清理")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="6%" style="vertical-align:middle; text-align:center;" style="display:none"><%=rs2.getString("assembly_item5")%></td>
<tr <%=TR_STYLE1%> class="TR_STYLE1" style="display:none">
...
<%
String stock_time=rs2.getString("mold_installation_check_time");
...
<tr  class="TR_STYLE1" >
 ...
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" value="<%=rs2.getString("mold_installation_checker")%>  " name="mold_purchase_supplier" type="text"  ></td>
