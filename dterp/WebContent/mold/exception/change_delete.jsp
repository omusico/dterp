...
try{
String sql="delete  from  mold_exception  WHERE id = '"+id+"'";
...
<table  class="TABLE_STYLE2" border="0">
	<tr  class="TR_STYLE1">
		<td><div>删除成功，请点击完成</div></td>
		<td  class="TD_STYLE3">
		<div  class="DIV_STYLE1">
		<input type="button" align="right" class="BUTTON_STYLE1" value="完成" onClick=location="check_list.jsp"></div>
		</td>
	</tr>
</table>
<%mold_db.close(); %>
