...
<form method="post" class="x-form" action="../../mold_register_picture_ex_ok?id=<%=id%>&mold_spec=<%=mold_spec%>&mold_code=<%=mold_code%>&stock_time=<%=stock_time%>" ENCTYPE="multipart/form-data" onsubmit="return formCheck()">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
