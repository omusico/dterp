...
.MOLD_INPUT_STYLE_IND{
bordercolor:#DDDDDD;
background-color:#FFFFFF;
width:100%
}
.MOLD_INPUT_STYLE_COP{
bordercolor:#DDDDDD;
...
String TD_STYLE7="";
String TD_STYLE8="";
String MOLD_INPUT_STYLE_IND="bordercolor=#DDDDDD background-color=#FFFFFF width=100%;";
String MOLD_INPUT_STYLE_COP="bordercolor=#DDDDDD background-color=#FFFFCC width=100%;";
String INPUT_STYLE1="";
String INPUT_STYLE3="";
String INPUT_STYLE4="";
String INPUT_STYLE5="";
