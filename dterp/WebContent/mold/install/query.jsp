...
<form id="mutiValidation" method="post" onSubmit="TwoSubmit(this)">
 <%--查询 订货单  Id--%>
 <%
...
<%--入库时间 --%>
<%
	String stock_time1=rs1.getString("stock_time");
    stock_time1=stock_time1.substring(0,10);
%>
...
<tr  class="TR_STYLE1" >
 ...
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" name="stock_time" type="text" value="<%=stock_time1%>"   ></td>
...
%>
 ...
 <td align=right class="TD_STYLE8" width="8%" style="display:none"><%=demo.getLang("erp","安装者")%>：</td>
 <td align=left class="TD_STYLE2" width="12%" style="display:none"><input style="width:100%" readonly="readonly" name="installer" type="text" value="<%=rs1.getString("installer")%>"  ></td>
 <td align=right class="TD_STYLE8" width="8%" style="display:none"><%=demo.getLang("erp","安装时间")%>：</td>
 <td align=left class="TD_STYLE2" width="12%" style="display:none"><input style="width:100%" readonly="readonly" name="installation_time" type="text" value="<%=rs1.getString("installation_time")%>"  ></td>
 <td align=right class="TD_STYLE8" width="8%"><%=demo.getLang("erp","供应商")%>：</td>
 <td align=left class="TD_STYLE2" width="12%" colspan="3"><input style="width:100%" readonly="readonly" name="mold_purchase_supplier" type="text" value="<%=rs2.getString("CUSTOMER_NAME")%>"  ></td>
 <td align=left class="TD_STYLE2" width="12%">&nbsp;</td>
 <td align=left class="TD_STYLE2" width="12%">&nbsp;</td>
 <td align=left class="TD_STYLE2" width="12%">&nbsp;</td>
 </tr>
...
<td <%=TD_STYLE4%> class="TD_STYLE1" width="14%" style="vertical-align:middle; text-align:left;"><%=demo.getLang("erp","2：上、下模用酒精清洗")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="6%" style="vertical-align:middle; text-align:center;"><%=rs2.getString("assembly_item2")%></td>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE4%> class="TD_STYLE1" width="14%" style="vertical-align:middle; text-align:left;"><%=demo.getLang("erp","5：纸带顶紧滑块、纸粉清理")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="6%" style="vertical-align:middle; text-align:center;"><%=rs2.getString("assembly_item5")%></td>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr style="background-image:url(../../images/line.gif)" style="width:" style="display:none"><td colspan="4"><div style="width:100%; height:12; padding:3px; " style="display:none"><%=demo.getLang("erp","安装检查信息")%></div></td></tr>
...
<td <%=TD_STYLE4%> class="TD_STYLE1" width="7%" style="vertical-align:middle; text-align:left;" style="display:none"><%=demo.getLang("erp","2：毛羽烧温度设定")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" style="vertical-align:middle; text-align:center;" style="display:none"><%=rs2.getString("installation_item2")%> </td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1" style="display:none">
...
<tr style="display:none">
<td <%=TD_STYLE4%> class="TD_STYLE1" width="7%" style="vertical-align:middle; text-align:left;" style="display:none"><%=demo.getLang("erp","5：模具处微调仪确认")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" style="vertical-align:middle; text-align:center;" style="display:none"><%=rs2.getString("installation_item5")%> </td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1" style="display:none">
...
<%
String stock_time=rs2.getString("mold_stock_check_time");
stock_time=stock_time.substring(0,stock_time.indexOf(" "));
%>

<table align=center class="TABLE_STYLE4" width = "100%" border="0"> 
<tr  class="TR_STYLE1" >
 <td align=right class="TD_STYLE8" width="8%"><%=demo.getLang("erp","登记人")%>：</td>
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" value="<%=rs2.getString("mold_ai_register")%> " name="mold_purchase_supplier" type="text"  ></td>
 <td align=right class="TD_STYLE8" width="8%"><%=demo.getLang("erp","登记时间")%>：</td>
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" value="<%=rs2.getString("mold_ai_regist_time")%> " name="mold_ai_regist_time" type="text"  ></td>
 <td align=right class="TD_STYLE8" width="8%"><%=demo.getLang("erp","审核人")%>：</td>
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" value="<%=rs2.getString("mold_stock_checker")%>  " name="mold_purchase_supplier" type="text"  ></td>
 <td align=right class="TD_STYLE8" width="8%"><%=demo.getLang("erp","审核时间")%>：</td>
 <td align=left class="TD_STYLE2" width="12%"><input style="width:100%" readonly="readonly" value="<%=stock_time%>  " name="mold_ai_regist_time" type="text"  ></td>
 <td align=right class="TD_STYLE8" width="8%">&nbsp;</td>
 <td align=left class="TD_STYLE2" width="12%">&nbsp;</td>
 </tr>
</table>
