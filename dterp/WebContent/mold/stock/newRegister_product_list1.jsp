...
function addSpec(strSpec,strLot_no)
{
...
['<%=rs1.getString("CUSTOMER_NAME") %>','<div style="text-decoration : underline;color:#3366FF" onClick=addSpec("<%=exchange.unHtmls(rs1.getString("CUSTOMER_NAME")) %>","<%=exchange.unHtmls(Integer.toString(rs1.getInt("id")))%>")><%=demo.getLang("erp","选择")%></div>'],	
