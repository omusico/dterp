...
String sql1 = "select * from mold_stock_pic where mold_id='"+request.getParameter("id")+"'";
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <td align=center class="TD_STYLE3"><img src="<%=url%>/upload_file/stock_pictures/stock_pictures_<%=mold_code%>_<%=stock_time%>/<%=rs1.getString("pic_path")%>"></td>
 </tr>
</table>
<%}
mold_db.close();
