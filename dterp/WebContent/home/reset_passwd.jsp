...
setGradient('example1','#A5E3FF','#ffffff',0);
 ...
 <p align="center"><b><font color="#800000" size="3"><%=demo.getLang("erp","上海慧索计算机科技ERP系统修改用户密码")%></b></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="80%" height="83">
        <tr>
          <td <%=TD_STYLE3%> class="TD_STYLE3" height="79" align="center"><%=demo.getLang("erp","上海慧索计算机科技版权所有 All Rights Reserved.")%>
          </td>
        </tr>
</table>       
