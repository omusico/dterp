...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="650"> 
 ...
 <p align="center"><b><font color="#800000" size="4"><%=demo.getLang("erp","慧索ERP系统")%></b></td></tr></TBODY></TABLE> 
<P> 
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <%=demo.getLang("erp","对不起，您没有权限，如有疑问请联系系统管理员，")%><%=demo.getLang("erp","或者请检查你的用户名是否有使用单位简称作前缀，系统默认的前缀为:dt_，请确认。")%>
 </td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
