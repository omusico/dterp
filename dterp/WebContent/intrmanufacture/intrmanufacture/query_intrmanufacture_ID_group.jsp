...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <%=demo.getLang("erp","其中审核状态：")%><font color="<%=color1%>"><%=exchange.toHtml(check_tag)%></font> <%=demo.getLang("erp","入库状态：")%><font color="<%=color2%>"><%=exchange.toHtml(stock_gather_tag)%></font>
 <%=demo.getLang("erp","付款状态：")%><font color="<%=color4%>"><%=exchange.toHtml(pay_tag)%></font> <%=demo.getLang("erp","发票状态：")%><font color="<%=color5%>"><%=exchange.toHtml(invoice_tag)%></font>
 <%=demo.getLang("erp","质检状态：")%> <font color="<%=color5%>"><%=exchange.toHtml(gather_tag)%></font></td>
 </tr>
 </table>
