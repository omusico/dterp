...
<%nseer_db db = new nseer_db("ondemand2");%>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="100%" >
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3" colspan="2"><%=demo.getLang("erp",rs.getString("first_kind_name"))%>-<%=demo.getLang("erp",rs.getString("second_kind_name"))%>-<%=demo.getLang("erp",rs.getString("third_kind_name"))%></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=<%=rs.getString("qq1")%>&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>&nbsp;<%=rs.getString("qq1")%><img SRC=http://wpa.qq.com/pa?p=10:<%=rs.getString("qq1")%>:10 border=0 ></font></a></td>
 </tr>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","QQ:")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3"><a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=<%=rs.getString("qq2")%>&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>&nbsp;<%=rs.getString("qq2")%><img SRC=http://wpa.qq.com/pa?p=10:<%=rs.getString("qq2")%>:10 border=0 ></font></a></td>
 </tr>
 <%}%>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","QQ:")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3"><a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=<%=rs.getString("qq3")%>&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>&nbsp;<%=rs.getString("qq3")%><img SRC=http://wpa.qq.com/pa?p=10:<%=rs.getString("qq3")%>:10 border=0 ></font></a></td>
 </tr>
<%}%>
...
if(!rs.getString("qq4").equals("")) {%>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","QQ:")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3"><a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=<%=rs.getString("qq4")%>&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>&nbsp;<%=rs.getString("qq4")%><img SRC=http://wpa.qq.com/pa?p=10:<%=rs.getString("qq4")%>:10 border=0 ></font></a></td>
 </tr>
