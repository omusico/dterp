...
<script type="text/javascript" src="../../javascript/include/validate/validation-framework.js"></script>
 ...
 <td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%="您正在做的业务是：库存管理--出库申请管理--出库申请登记审核"%></div></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="001002002"></td>
  ...
  <tr>
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="9%">出库人&nbsp;&nbsp;：</td><td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="admin"></td>
   <td <%=TD_STYLE1%> class="TD_STYLE8" width="9%">出库理由：</td><td><input type="text" size="80" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name"  value="成品出库" /></td>
  </tr>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1" >
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2">B001</td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1" >
 <td <%=TD_STYLE2%> class="TD_STYLE2"></td>
