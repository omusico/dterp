...
String fileName="register_change_list1.jsp";
...
<%
String sql = "select stock_in_apply.apply_in_apply_check_status,stock_in_apply.apply_in_apply_checker,stock_in_apply.apply_in_apply_check_time from stock_in_apply left join stock_in_apply_detail on stock_in_apply.id=stock_in_apply_detail.apply_in_id where stock_in_apply_detail.In_Detail_product_id='"+rs1.getString("product_info.id")+"'";
String status = "";
String person ="";
String personTime = "";
ResultSet rs = stock_b.executeQuery(sql);
if(rs.next()){
status = rs.getString("stock_in_apply.apply_in_apply_check_status");
person = rs.getString("stock_in_apply.apply_in_apply_checker");
personTime = rs.getString("stock_in_apply.apply_in_apply_check_time");
}
