...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="<%=request.getParameter("audOrder") %>"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="<%=rs.getString("apply_out_id") %>"></td>
  ...
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="11%">出库人：</td><td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="<%=rs.getString("apply_out_operator") %>"></td>
   ...
   <%if(proId==3){ %>
   <td><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" readonly="readonly" name="gatherer_name"  value="原材料出库" /></td>
  <%}else if(proId==5){ %>
  <td><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" readonly="readonly" value="成品出库" /></td>
  <%} %>
  </tr>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="10%"><%=demo.getLang("erp","库位")%></td>
 ...
 <%
	sql = "select * from stock_out_apply_detail inner join product_info on product_info.id =stock_out_apply_detail.out_Detail_product_id   where apply_out_id='"+rs.getString("id")+"'";
...
<tr <%=TR_STYLE1%> class="TR_STYLE1" >
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="cost_price" type="text"  onFocus="this.blur()" value="<%=rs45.getString("product_info.product_stock")%>"></td>
...
<table <%=TABLE_STYLE5%> class="TABLE_STYLE5" cols=1 id=tableOnlineEdit1
	...
	<thead>
		...
		<tr <%=TR_STYLE1%> class="TR_STYLE1">
			...
			<td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%>
				class="INPUT_STYLE4" name="cost_price" type="text"
				onFocus="this.blur()" value="<%=rs45.getString("package_count") %>"></td>
 
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="cost_price" type="text"  onFocus="this.blur()" value="<%=rs45.getString("package_info.package_stock") %>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<%String checkTime = rs.getString("apply_out_register_time");
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input name="register_time" type="hidden" value="<%=checkTime%>">
 <input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" readonly="readonly" 
 name="gatherer_name"  value="<%=checkTime %>" />
</td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="11%"><%=demo.getLang("erp","审核人")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left">
 <input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="register" 
 value="<%=rs.getString("apply_out_checker") %>"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="11%"><%=demo.getLang("erp","审核时间")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left">
 <input name="register_time" type="hidden" value="<%=rs.getString("apply_out_check_time")%>">
  <input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" readonly="readonly" name="gatherer_name"  
  value="<%=rs.getString("apply_out_check_time") %>" />
 </td>
 </tr>
 </table>
 <%
