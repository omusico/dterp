...
String mod=request.getRequestURI();
 ...
 <script>
 	function openSearch(ag,av){
 		window.location.href="change_detail.jsp?id="+ag+"&proId="+av;
 	}
 </script>
<%
...
String my_sql_search = "select * from stock_in_apply where apply_in_apply_check_status!=1 ";
...
'<%=sh%>',
'<%=rk%>',
'<div style="text-decoration : underline;color:#3366FF;" onclick="openSearch(<%=rs1.getString("id")%>,<%=rs1.getString("apply_in_apply_reason_id")%>)">更改</div>'
],<%}%>
</page:pages>
['']];
nseer_grid.init();
