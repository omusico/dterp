...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" background="/images/tab_inactive1.jpg" style="border-collapse: collapse">
        <tr>
          ...
          <p class="style1" align="left"><font color="#ffffff"style="font-size: 13"><%=current%></font>  <font id="Clock" align="center" style="font-size: 13; color:#ffffff"></font>&nbsp;<font color="#ffffff"><%=weekday%></font><font color="#ffffff"><%=uname%>&nbsp;<%=demo.getLang("erp","您好!")%></p>          </td>
<%
