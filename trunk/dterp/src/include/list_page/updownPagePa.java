...
str1+="<input type=\"hidden\" name=\""+name_value[i].split("=")[0]+"\" value=\""+name_value[i].split("=")[1]+"\">";
         ...
         pageContext.getOut().print(demo.getLang("erp","共")+PageCount+demo.getLang("erp","页")+"  &nbsp;&nbsp;&nbsp;"+
									...
									"<input type=image src=\""+request.getContextPath()+"/images/go.bmp\" width=18 height=18 border=0></div><script>function _nseer_pageVali(o){if(isNaN(parseInt(o.value))){o.value='';}else{o.value=''+parseInt(o.value);}}</script>");
