...
SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		...
		while(rsdb.next()){
			if(rsdb.getString("database").equals("ondemand2")){
			...
			nseer_db.executeUpdate(sqll);
			sqll="insert into document_config_public_char(kind,type_name,describe1,describe2) values('数据源','//localhost:3306/ondemand2','sql','"+getPath().substring(1,getPath().indexOf("WEB-INF"))+"')";
			nseer_db.executeUpdate(sqll);
