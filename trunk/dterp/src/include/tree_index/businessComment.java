...
while (tokenTO1.hasMoreTokens()) {
	...
	if(unit_db_name==null) unit_db_name="ondemand2";
}
}
...
public String businessComment(String url,String base,String table_name,String field_name,String field_name1){
	BusFirst bf=new BusFirst();
	ab=bf.businessComment(url, base, table_name, field_name, field_name1, unit_db_name);
	return ab;
}
