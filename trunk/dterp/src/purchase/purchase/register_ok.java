...
List rsList = GetWorkflow.getList(purchase_db, "purchase_config_workflow", "06");
    ...
    if(rsList.size()==0){
		...
		String sqll = "update purchase_purchase set check_tag='2' purchase_tag='1',invoice_tag='1',gather_tag='1',stock_gather_tag='1',pay_tag='1' where purchase_ID='"+purchase_ID+"'" ;
	...
	String sql = "update purchase_purchase set list_price_sum='"+list_price_sum+"',list_price='"+list_price+"',checker='"+register+"',check_time='"+register_time+"',purchase_tag='1',invoice_tag='1',gather_tag='1',stock_gather_tag='1',pay_tag='1'where purchase_ID='"+purchase_ID+"'" ;
	purchase_db.executeUpdate(sql) ;
