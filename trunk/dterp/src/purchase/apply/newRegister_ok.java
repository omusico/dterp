...
String real_cost_price="";
	...
	String sql = "insert into purchase_apply(apply_ID,product_ID,product_name,product_describe,amount,remark,register,register_time,new_tag) values('"+apply_ID+"','"+product_ID+"','"+product_name+"','"+product_describe+"','"+amount+"','"+remark+"','"+register+"','"+register_time+"','1')";
