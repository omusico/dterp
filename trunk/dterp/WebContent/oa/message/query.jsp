...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%" colspan="3"><%=rs.getString("check_amount")%>&nbsp;&nbsp;<a href="javascript:winopenm('query_details.jsp?message_ID=<%=rs.getString("message_ID")%>')"><%=demo.getLang("erp","发送明细")%></a></td>
</tr>
</table>
