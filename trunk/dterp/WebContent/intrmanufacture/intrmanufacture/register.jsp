...
<form id="mutiValidation"  method="POST" action="../../intrmanufacture_intrmanufacture_register_ok" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_intrmanufacture.xml','mutiValidation')">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../intrmanufacture_intrmanufacture_register_draft_ok','../../xml/intrmanufacture/intrmanufacture_intrmanufacture.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="register_list.jsp"></div></td> 
 </tr>
 </table>
