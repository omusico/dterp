...
<form name="" id="" action="../../stateDepart" method="post" onsubmit="return formCheck()"   enctype="multipart/form-data" >
<table width="100%">
	<tr>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;
		读取文件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
			name="fileNameC" id="fileNameC" type="file" <%=BUTTON_STYLE1%> contenteditable="false" onkeypress="return false;"  class="BUTTON_STYLE1" size="70" />
		</td>
