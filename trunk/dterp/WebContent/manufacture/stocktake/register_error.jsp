...
<table width="100%">
<tr>
	<td style="text-align: left">您上传的不是有效文件，请重新上传！</td>
	<td style="text-align:right"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="registerCheck()" value="<%=demo.getLang("erp","确定")%>"></td>
</tr>
</table>
