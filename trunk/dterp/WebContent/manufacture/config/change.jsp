...
<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" id=theObjTable>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		<td <%=TD_STYLE4%> class="TD_STYLE1" width="4%"><%=demo.getLang("erp", "湿度（%RH）")%>
		</td>
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_4_1_1" style="width:6%"
			value="<%=data_4_1_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_4_1_2" style="width:6%"
			value="<%=data_4_1_2%>"></td>
	</tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		<td <%=TD_STYLE4%> class="TD_STYLE1" width="4%"><%=demo.getLang("erp", "温度（°C）")%>
		</td>
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_4_2_1" style="width:6%"
			value="<%=data_4_2_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_4_2_2" style="width:6%"
			value="<%=data_4_2_2%>"></td>
	</tr>
	</table>
	<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" id=theObjTable>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_8_1_1" style="width:6%"
			value="<%=data_8_1_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_8_1_2" style="width:6%"
			value="<%=data_8_1_2%>"></td>
	</tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		<td <%=TD_STYLE4%> class="TD_STYLE1" width="4%"><%=demo.getLang("erp", "温度（°C）")%>
		...
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_8_2_1" style="width:6%"
			value="<%=data_8_2_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_8_2_2" style="width:6%"
			value="<%=data_8_2_2%>"></td>
	</tr>
	</table>
	<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" id=theObjTable>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1"  type="text" name="data_hole_1_1" style="width:6%"
			value="<%=data_hole_1_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_hole_1_2" style="width:6%"
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_hole_2_1" style="width:6%"
			value="<%=data_hole_2_1%>">&nbsp;&nbsp;&nbsp;～&nbsp;&nbsp;<input
			<%=INPUT_STYLE1%> class="INPUT_STYLE1" type="text" name="data_hole_2_2" style="width:6%"
