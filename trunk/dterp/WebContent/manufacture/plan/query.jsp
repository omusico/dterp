...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<%-- 
		<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","打印")%>" onClick="javascript:winopen('query_print.jsp?apply_ID=<%=apply_ID%>')">&nbsp;
		--%>
...
<%
	...
	String sql = "select id,plan_make_time,plan_no,plan_check_tag,plan_class,plan_id,plan_type,plan_maker,plan_register,plan_register_time,plan_checker,"
	+"plan_check_time,plan_remark from product_plan where id="+ id;
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td align=left class="TD_STYLE2" width="40%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="" type="text" value="<%=rs_all.getString("plan_register_time").substring(0,10) %>" onFocus="this.blur()" style="width: 150"></td>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td align=left class="TD_STYLE2" width="40%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="" type="text" value="<%=rs_all.getString("plan_check_time").substring(0,10) %>" onFocus="this.blur()" style="width: 150"></td>
