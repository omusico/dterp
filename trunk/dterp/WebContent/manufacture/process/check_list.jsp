...
<form name="mutiValidation" ENCTYPE="multipart/form-data" method="post" action="../../manufacture_process_UploadPackage" onsubmit="return checkForm()">

<input name="human_ID" type="hidden" value="<%=human_ID %>">
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td bordercolorlight=#848284 bordercolordark=#ffffff class="TD_STYLE8" align="center" style="width: 1%">
	&nbsp;</td>
		<td bordercolorlight=#848284 bordercolordark=#ffffff class="TD_STYLE8" align="left" style="width: 70%">
		<%=demo.getLang("erp", "读取文件")%>：<input type="file" contenteditable="false" <%=FILE_STYLE1%> class="FILE_STYLE1" name="file1" size="60">
		</td>
