...
function result(ag){
	window.location.href="package_2.jsp";
}
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="100%">
 ...
 <td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%="您正在做的业务是：生产管理--生产过程管理--产品包装"%></div></td>
 </tr>
 </table>
...
附件类型错误或附件容量太大(最大1024 / 1024 KB),请点击确定从新添加！
</td>
