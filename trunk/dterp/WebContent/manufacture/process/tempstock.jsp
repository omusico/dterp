...
<script type="text/javascript">
	...
	//11.11加入品管仓库文件以P结尾
	if(sufferName!="B"&&sufferName!="C"&&sufferName!="D"&&sufferName!="E"&&sufferName!="F"&&sufferName!="G"&&sufferName!="O"&&sufferName!="P"){
...
<form name="" id="" action="../../tempStock" method="post" onsubmit="return formCheck()"   enctype="multipart/form-data" >
<table width="100%">
	<tr>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;
		读取文件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
			name="fileNameC" id="fileNameC" contenteditable="false" type="file" <%=BUTTON_STYLE1%> size="70" class="BUTTON_STYLE1" />
		</td>
