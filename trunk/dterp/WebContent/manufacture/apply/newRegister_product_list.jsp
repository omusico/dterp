...
<jsp:useBean id="available" class="stock.getBalanceAmount"
	scope="request" />
<jsp:useBean id="column" class="include.get_sql.getKeyColumn"
	scope="page" />
...
<%
		String design_type=request.getParameter("type");//1-4分切，2-8mm切，3-打孔
