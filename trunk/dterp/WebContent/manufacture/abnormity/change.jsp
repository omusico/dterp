...
<form id="mutiValidation" method="post" onSubmit="return CheckForm(this)" action="change_ok.jsp?event_product_id=<%=exchange.unHtmls(Integer.toString(rs1.getInt("event_product_id")))%>">
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE2%> class="TD_STYLE2" width="16%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="event_name" type="text" value="<%=rs1.getString("event_name")%>" ></td>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE2%> class="TD_STYLE2" width="16%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="event_count" type="text" value="<%=rs1.getString("event_count")%>" ></td>
		<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp", "异常卷数")%>&nbsp;&nbsp;：</td>
		<td <%=TD_STYLE2%> class="TD_STYLE2" width="16%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="event_exception_count" type="text" value="<%=rs1.getString("event_exception_count")%>" ></td>
		<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp", "附样件数")%>&nbsp;&nbsp;：</td>
		<td <%=TD_STYLE2%> class="TD_STYLE2" width="16%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="event_attach_count" type="text" value="<%=rs1.getString("event_attach_count")%>" ></td>
		<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp", "发生时间")%>&nbsp;&nbsp;：</td>
		<td <%=TD_STYLE2%> class="TD_STYLE2" width="16%">
		<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="event_take_time" type="text" value="<%=rs1.getString("event_take_time")%>" id="event_take_time" onkeypress="event.returnValue=false;">
		</td>
	</tr>
</table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
  <tr>
    ...
    <td>
  		  <textarea class="TEXTAREA_STYLE1" name="operator_ex" style="width:100%" rows="4" ><%=rs1.getString("operator_ex")%></textarea>
    ...
    <td>
  		  <textarea class="TEXTAREA_STYLE1" name="repair_ex" style="width:100%" rows="4" ><%=rs1.getString("repair_ex")%></textarea>
  	</td> 
  </tr>
      <tr>
    <td width="10%" align="right" style="vertical-align:top;"></td>
    <td></td> 
  </tr>
</table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" style="display:none">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
