...
<page:pages rs="<%=rs%>" strPage="<%=strPage%>">
      <a href="index_details.jsp?id=<%=rs.getString("id")%>" target="_blank"><%=exchange.toHtml(rs.getString("human_major_first_kind_name"))%>--<%=exchange.toHtml(rs.getString("human_major_second_kind_name"))%>--<%=exchange.toHtml(rs.getString("first_kind_name"))%>--<%=exchange.toHtml(rs.getString("second_kind_name"))%>--<%=exchange.toHtml(rs.getString("third_kind_name"))%></a><br/>
</page:pages>
</td>
      </tr>
      <tr>
