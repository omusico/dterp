...
%>
 ...
 WebBase wb=new WebBase("ondemand2","nseer");
 ColumnMain cm=new ColumnMain();
 Table tb=new Table();
 String[] cols_main=cm.getColumn("ondemand2","nseer","ecommerce_colsa");
String[] cols_top=cm.getColumn("ondemand2","nseer","ecommerce_cols_top");
String[] cols_bottom=cm.getColumn("ondemand2","nseer","ecommerce_cols_bottom");
...
<%
	String qq1="";
	String qq2="";
nseer_db db_index = new nseer_db("ondemand2");
   ...
   <td bgcolor="#D6FAFA" class="STYLE1" border="0"><table width="100" border="0" cellpadding="0" cellspacing="0">
       <tr>
         <td height="4"><table width="118" border="0" cellpadding="0" cellspacing="0">
           ...
           <tr>
             <td>
		 <a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=491438396&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>491438396<img SRC=http://wpa.qq.com/pa?p=10:491438396:10 border=0 ></font></a><br>
		 <a target=blank href=http://wpa.qq.com/msgrd?V=1&amp;Uin=772861935&amp;Site=上海慧索计算机科技&amp;Menu=yes><font style=font-size:12px;>772861935<img SRC=http://wpa.qq.com/pa?p=10:772861935:10 border=0 ></font></a><br><br>
...
String[] record=tb.getTable("ondemand2","nseer",cols_main[m]);
%>
...
if(record[3].equals("other")){
	sql="select * from "+record[0]+" where "+record[1]+" and chain_ID!='01' and chain_ID!='02' and chain_ID!='03' limit 8";
}else{
