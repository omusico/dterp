...
try{
String sql= "update mold_assembly_installation SET mold_stock_checker = '"+realname+"',mold_stock_check_time = '"+time+"' WHERE mold_id = '"+id+"'";
mold_db.executeUpdate(sql);
sql= "update mold_info SET mold_location = '"+3+"',mold_life_status='"+4+"' WHERE id = '"+id+"'";
mold_db.executeUpdate(sql);
mold_db.close();
}catch (Exception ex){
ex.printStackTrace();
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<div class="div_handbook"><%="您正在做的业务是：模具管理--模具组装管理--模具组装审核"%></div>
		</td>
	</tr>
</table>
