...
register_time=rs1.getString("exception_regist_time");
if(register_time.length()>9)
{
...
<%
 String check_type=rs1.getString("mold_status");
String check_time="";
if(!check_type.equals("0"))
{
	check_time=rs1.getString("exception_check_time");
...
<tr><td>&nbsp;&nbsp;</td></tr>
  <tr>
   ...
   <td width="41%"><input readonly="readonly" name="exception_checker" value="<%=rs1.getString("exception_checker")%>" type="text" style="border-bottom: 1px solid #000;border-top: 0px solid #000;border-left: 0px solid #000;border-right:0px solid #000; width : 50%"></td>
    <td width="10%" align=right>审核时间：</td>
    <td width="40%"><input readonly="readonly" name="exception_check_time" value="<%=check_time%>" type="text" style="border-bottom: 1px solid #000;border-top: 0px solid #000;border-left: 0px solid #000;border-right:0px solid #000;width : 50% " ></td>
  <td style="display:none"><input id="id" name="id"></td>
  </tr>
</table>
