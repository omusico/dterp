...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<div class="div_handbook"><%="您正在做的业务是：模具管理--模具拆卸管理--模具拆卸登记"%></div>
		</td>
	</tr>
</table>
<table  class="TABLE_STYLE2" border="0">
	<tr  class="TR_STYLE1">
		<td><div>&nbsp;&nbsp;模具拆卸登记成功，请点击完成</div></td>
		<td  class="TD_STYLE3">
		<div  class="DIV_STYLE1">
		<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="继续上传" onClick="history.back();">
		<input type="button" align="right" class="BUTTON_STYLE1" value="完成" onClick=location="change_list.jsp"></div>
		</td>
	</tr>
</table>
