...
<%
    ...
    path=path+"/mold/uninstall/query_list.jsp";
%>
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="location.href='<%=path%>'"></div>
		</td>
	</tr>
</table>
...
<%--@include file="../include/paper_top.html"--%>
 ...
 <table align="center" width="100%"  border="0">
  ...
  <tr>
    ...
    <td class="TD_STYLE2" width="26%"><input readonly="readonly" value="<%=rs1.getString("destruction_time")%>" name="destruction_time" type="text"   ></td>
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td align=right><input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","查看拆卸照片")%>" onclick="openS()" style="width:80px;height:22px;" ></td>
	</tr>
</table>
...
<%
	String unTime="";
    unTime=rs1.getString("mold_destruction_check_time");
    if(unTime.length()>9)
    {
    	unTime=unTime.substring(0,10);
    }
...
<table align="center" width="100%"  border="0">
  <tr>
    ...
    <td  class="TD_STYLE2" width="40%"><input readonly="readonly" value="<%=rs1.getString("mold_destruction_regist_time")%>" name="mold_destruction_regist_time" value=<%=time %> type="text"   ></td>
  </tr>
  </table>
  <table align="center" width="100%"  border="0">
  <tr>
    ...
    <td  class="TD_STYLE2" width="40%"><input readonly="readonly" name="mold_destruction_check_time" value="<%=unTime%>" type="text"   ></td>
  </tr>
  </table>
<%	
mold_db.close();
