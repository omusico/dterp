...
<%
		...
		//审核未通过的信息
		String my_sql_search = "select id,product_ID,product_name,type,chain_name from design_file where C_DEFINE1='0' and check_tag=0 "+my_condition+" order by id desc";
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
	...
	%>
		<td <%=TD_STYLE6%> class="TD_STYLE6">产品编号：
		  <input type="text" name="product_id" onfocus="" id="" value="<%=product_id %>" style="width: 18%">
		  产品名称：
		  <input type="text" name="product_name" onfocus="" id="" value="<%=product_name %>" style="width: 18%">
		  用途类型：
...
nseer_grid.column_width=[180,180,100,180,60];
