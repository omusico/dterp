  ...
  <table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="650">
    <tr>
      <td <%=TD_STYLE3%> class="TD_STYLE3">	
        <p align="center"><b><font color="#800000" size="3"><%=demo.getLang("erp","慧索ERP系统用户注册")%></font></b></td>
    </tr>
  </table>
...
<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" style="width:65%" align="center">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="75%" colspan="2"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="unit_name" style="width:33%" value="dt" id="nseer_name" onFocus="this.blur()"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="80%" height="83">
        <tr>
          <td <%=TD_STYLE3%> class="TD_STYLE3" height="79" align="center"><%=demo.getLang("erp","上海慧索计算机科技有限公司版权所有 All Rights Reserved.")%>
          </td>
        </tr>
</table>       
