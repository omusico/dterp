...
<%@page contentType="text/html; charset=UTF-8" language="java"
	import="include.nseer_db.*,include.operateXML.*,java.sql.*"
	import="java.util.*" import="java.text.*" import="java.io.*"%>

<jsp:useBean id="demo" class="include.tree_index.businessComment"
	scope="page" />
<jsp:useBean id="unitinfo" class="include.nseer_cookie.UnitInfo"
	scope="page" />
<%
...
<script type="text/javascript"
	src="../javascript/include/div/divcolor.js"></script>
<TABLE width="80%" height="90%" border=0 cellPadding=0 cellSpacing=0
	align="center" bgcolor="#F3F6F7" class="example" id="example1">
	<script>
setGradient('example1','#A5E3FF','#ffffff',0);
	...
	<TBODY>
		...
		<TR>
			...
			%>
			<p align="left" style="padding-left: 310"><font color="#008000"
				size="2"><%=demo.getLang("erp","恭喜您注册成功，请牢记您的用户名和密码！")%>
			...
			<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1"
				value="<%=demo.getLang("erp","返回")%>" onClick=location="login.jsp">
			<p align="center">
			<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="650"
				cellpadding="2">
				<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
setGradient('example1','#A5E3FF','#ffffff',0);
				...
				<TBODY>
					...
					<TR>
						<TD background="../images/bg_03.gif"></TD>
						<TD>
						<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="4"
							width="400" cellspacing="4">
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
								<p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","对不起，许可证已超出有效期，请联系系统管理员！")%>
								</td>
							</tr>
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
							...
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
								<p align="center"><input type="button" <%=BUTTON_STYLE1%>
									class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>"
						...
						<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
								<p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","对不起，用户姓名或许可证错误，请重新注册！")%>
								</td>
							</tr>
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" width="15%"></td>
						...
						<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="4"
							...
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
								<p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","对不起，用户名重复，请返回重新注册！")%>
								</td>
							</tr>
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" width="15%"></td>
						...
						<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="4"
							...
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
								<p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","数据库连接故障，请返回。")%>
								</td>
							</tr>
							<tr <%=TR_STYLE1%> class="TR_STYLE1">
								<td <%=TD_STYLE3%> class="TD_STYLE3" width="15%"></td>
