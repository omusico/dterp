...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="100%">
 ...
 <td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%="您正在做的业务是：库存管理--入库申请管理--入库申请登记"%></div></td>
 </tr>
 </table>
...
<input type="button" class="BUTTON_STYLE1" onclick="result()" value="<%=demo.getLang("erp","返回")%>">
</td>
</tr>
</table>
</form>
