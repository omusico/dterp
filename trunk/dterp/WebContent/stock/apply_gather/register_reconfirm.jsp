...
<form id="mutiValidation" method="POST" action="../../stock_apply_gather_register_ok" onSubmit="return doValidate('../../xml/stock/stock_apply_gather.xml','mutiValidation')&&CheckForm(this)">
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDraft("'mutiValidation','../../stock_apply_gather_register_draft_ok','../../xml/stock/stock_apply_gather.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","确认")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();">&nbsp;<input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></td>
	 </tr>
	 </table>
<%
...
<input type="hidden" name="new_apply" value="<%=exchange.toHtml(new_apply)%>">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="<%=gatherer_name%>"></td>
...
<%}%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input name="demand_return_time" <%=INPUT_STYLE3%> class="INPUT_STYLE3" type="text" onfocus="" value="<%=exchange.toHtml(demand_return_time)%>" id="date_start"></td>
 </tr>
</table>
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount_unit<%=i%>" value="<%=exchange.toHtml(amount_unit[i])%>" onFocus="this.blur()"></td>
