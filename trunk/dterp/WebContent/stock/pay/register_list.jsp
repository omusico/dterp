...
<form name="" id="" action="../../comeDepart" method="post" onsubmit="return formCheck()"   enctype="multipart/form-data" >
<table width="100%">
	<tr>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;
		读取文件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
			name="fileNameC" id="fileNameC" type="file" onkeypress="return false;" contenteditable="false" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" size="70" />
		</td>
