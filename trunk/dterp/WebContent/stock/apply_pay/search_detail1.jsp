...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE8">
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="" value="<%=demo.getLang("erp","打印出库单")%>">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="register" value="<%=exchange.toHtml(register)%>"></td>
