...
{
	if(rad){
		document.forms[0].action="../../stock_product_comeoutProAction.do?m=noAudting&orderId="+orderId;
	}else{
		document.forms[0].action="../../stock_product_comeoutProAction.do?m=audting&orderId="+orderId;
	}
}else
{
	return false;
...
<style type="">
.INPUT_STYLE3{
text-align: left"><input type="text"  style="border-bottom: 1px solid #000;border-top: 0px solid #000;border-left: 0px solid #000;border-right:0px solid #000;
}
</style>
...
<form id="mutiValidation" method="POST" action="" onsubmit="return productCheck(<%=id %>)" >
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8">
 <input type="radio" id="radio" name="radio" onclick="chcekRadio1()" checked /> 未通过 &nbsp; <input type="radio" onclick="chcekRadio()" name="radio" /> 通过&nbsp;
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" readonly="readonly" value="<%=rs.getString("apply_out_id") %>"></td>
  </td>
  </tr>
  <tr>
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="11%">出库人：</td><td <%=TD_STYLE2%> class="TD_STYLE2" width="40%" style="text-align: left"><input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="gatherer_name" value="<%=rs.getString("apply_out_operator") %>"></td>
   <%
		...
		<td  style="text-align: left"><input type="text" <%=INPUT_STYLE3%> readonly="readonly"
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td  width="40%"><%=rs.getString("apply_out_count") %></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"  style="text-align: left"><input type="text" readonly="readonly" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="registerPerson" value="<%=session.getAttribute("realeditorc")%>"></td>
 ...
 <input name="register_time" type="hidden" value="<%=exchange.toHtml(time)%>">
  <input type="text" name="registerTime" <%=INPUT_STYLE3%> class="INPUT_STYLE3" readonly="readonly" value="<%=time.substring(0,10)%>" />
 </td>
 </tr>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3" width="89%"><textarea
			<%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="remark1" id="remark2" style="background-color:#FFFFCC" ></textarea>
			<textarea
			<%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="remark26" style="display: none" id="remark26" readonly="readonly"></textarea>
		</td>
	</tr>
 </table>
 <%
