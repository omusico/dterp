...
function result(){
	window.location.href="payingGatheringQuery_list.jsp";
}
...
上传的文件中替换的数量与被替换的数量不一致，请检查后重新上传!
</td>
<td style="text-align: right;">
<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="result()" value="<%=demo.getLang("erp","确定")%>">
</td>
</tr>
</table>
</form>
