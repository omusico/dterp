...
<div id="nseerGround" class="nseerGround">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  <%=demo.getLang("erp","临时托盘号和现场托盘号关联成功！")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  <div <%=DIV_STYLE1%> class="DIV_STYLE1"> 
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick=location="relationship.jsp"></div></td>
 </tr>
 </table>
