...
%>
 <div id="my_nseer_ad" style="position:absolute;bottom:10px;right:12px;width:400px;height:150px;"><TABLE width="100%" height="100%" border="0" align="center" cellPadding="0" cellSpacing="0"><TBODY><TR><TD width="1%" height="1%"><IMG  src="../images/bg_0ltop.gif"></TD><TD width="100%" background="../images/bg_01.gif"></TD><TD width="1%" height="1%"><IMG  src="../images/bg_0rtop.gif"></TD></TR><TR><TD  background="../images/bg_03.gif"></TD><TD><div style="position:absolute;top:10px;width:380px;height:130px;background:#F0F3F5;"><div style="height:50px;text-align:left;color:#FF00FF;line-height:150%;padding-top:7px;padding-left:10px;padding-right:10px;"><%=notice_content %></div></div><span style="position:absolute;top:2px;right:7px;width:18px;height:18px;cursor:hand;" onclick="document.getElementById('my_nseer_ad').style.display='none';"><img src="../images/gb.gif" border="0" width=17px;height=17px></span></div></div> </TD><TD  background="../images/bg_04.gif"></TD></TR><TR><TD width="1%" height="1%"><IMG  src="../images/bg_0lbottom.gif" ></TD><TD background="../images/bg_02.gif"></TD><TD width="1%" height="1%"><IMG  src="../images/bg_0rbottom.gif"></TD> </TR></TBODY></TABLE></div>
<%
	}
%>
