...
String txtPager="";
String txtPerson="";
String my_sql_search = "select * from security_users  inner join hr_file on hr_file.human_id=security_users.human_id  where  security_users.human_ID!='' and type='0' and forbid_tag='0' ";
