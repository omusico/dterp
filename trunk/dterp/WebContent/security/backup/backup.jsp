...
<%@page contentType="text/html; charset=UTF-8" language="java"
	errorPage="/error.htm" import="java.sql.*,include.nseer_cookie.*"
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		...
		<div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button"
			...
			value="<%=demo.getLang("erp","确认")%>" onClick=location="../../security_backup_backup_ok"></div>
		</td>
	</tr>
</table>
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
		<td <%=TD_STYLE3%> class="TD_STYLE3" width="70%"><%=demo
									.getLang("erp",
											"确认全部备份下载吗？这个过程可能需要几分钟，请耐心等待。出现下载完成提示或下载窗口关闭则备份成功，请返回。")%></td>
