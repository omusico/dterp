...
<input type="hidden" name="textRemark" value="<%=request.getParameter("demand")%>" />
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该人力资源档案审核未通过，您确认吗？")%></td>
 </tr> 
<%
String remark = request.getParameter("demand");
int i=1;
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <INPUT name="choice" type="radio" <%=RADIO_STYLE1%> class="RADIO_STYLE1" value="<%=rs6.getString("config_id")%>"><%=demo.getLang("erp",choice)%></td>
 </tr>
<%
}
hr_db.close();
%>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><INPUT name="choice" type="hidden" <%=RADIO_STYLE1%> class="RADIO_STYLE1" value=""></td>
 </tr>
 </table>
</form>
 </div> 