...
<table <%=TABLE_STYLE4%> style="width:98%">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","姓名：")%><%=rs.getString("human_name")%>&nbsp;</td>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","所在部门：")%><%=rs.getString("chain_name")%>&nbsp;</td>
 </tr>	
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","有效期：")%><%=rs.getString("expiry_period")%><%=demo.getLang("erp","(天)")%></td>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
	<%String timeLogin = rs.getString("register_time");timeLogin=timeLogin.substring(0,10); %>
   <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","发放时间：")%><%=timeLogin%>&nbsp;</td>
 </tr>
 </table> 
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
