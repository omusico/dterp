...
var boxObj = document.getElementsByTagName("input");
 for(i=0;i<boxObj.length;i++)
 {
  if(boxObj[i].type=="checkbox"){
  		if(boxObj[i].checked)
 		 {
      	document.forms[0].method = "post";
		document.forms[0].action = "fieldType_delete_getPara.jsp";
...
<form name="type" method="" action="">
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3">
<div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","添加")%>" onClick=location="fieldType_register.jsp">&nbsp;<input type="button" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","删除")%>" onClick="preview()"></div></td>
</tr>
</table>
-->
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
